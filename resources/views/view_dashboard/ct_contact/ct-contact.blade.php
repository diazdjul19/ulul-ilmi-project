                ...
                <div class="modal fade" id="modal-create">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="{{route('ct-contact.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                        ...
                        <tbody>
                            @foreach ($data as $d)
                                <tr class="">
                                    ...
                                    <td style="">{{$d->name_contact}}</td>
                                    <td class="text-center">{{$d->md5_unik_code}}</td>
                                    <td class="text-center" style="width:50%;">
                                        @if ($d->md5_unik_code == "0de562d7e944350816715e354eaf7a70")
                                    ...
                                    <td class="text-center">
                                        <a href="{{route('ct-contact.edit', $d->id)}}" class="btn btn-success btn-xs" style="margin: 3px;"><i class="fa fa-edit"></i> Edit</a>
                                    </td>
                                </tr>
                            @endforeach
                            <tr class="text-center" data-toggle="modal" data-target="#modal-create">
                                @if ($cekkode_judul_kata_pengantar == null)
                                    ...
                                    <td><a href="#" data-toggle="tooltip" title="Klik ini untuk mengisi data tersebut." data-placement="bottom">{{$md5_judul_kata_pengantar}}</a></td>
                                    <td class="text-center">-</td>
                                    <td class="text-center">-</td>
                                @endif
                            </tr>
                            ...
                            <tr class="text-center" data-toggle="modal" data-target="#modal-create">
                                @if ($cekkode_kata_pengantar == null)
                                    ...
                                    <td><a href="#" data-toggle="tooltip" title="Klik ini untuk mengisi data tersebut." data-placement="bottom">{{$md5_kata_pengantar}}</a></td>
                                    <td class="text-center">-</td>
                                    <td class="text-center">-</td>
                                @endif
                            </tr>
                            ...
                            <tr class="text-center" class="text-center" data-toggle="modal" data-target="#modal-create">
                                @if ($cekkode_iframe_googlemaps == null)
                                    ...
                                    <td><a href="# " data-toggle="tooltip" title="Ukuran Ideal Ifame Google : width: 100%; height: 500px;" data-placement="bottom">{{$md5_iframe_googlemaps}}</a></td>
                                    <td class="text-center">-</td>
                                    <td class="text-center">-</td>
                                @endif
                            </tr>
                            ...
                            <tr class="text-center" class="text-center" data-toggle="modal" data-target="#modal-create">
                                @if ($cekkode_alamat_lengkap == null)
                                    ...
                                    <td><a href="# " data-toggle="tooltip" title="Klik ini untuk mengisi data tersebut." data-placement="bottom">{{$md5_alamat_lengkap}}</a></td>
                                    <td class="text-center">-</td>
                                    <td class="text-center">-</td>
                                @endif
                            </tr>
                            ...
                            <tr class="text-center" class="text-center" data-toggle="modal" data-target="#modal-create">
                                @if ($cekkode_nomer_telpon == null)
                                    ...
                                    <td><a href="# " data-toggle="tooltip" title="Klik ini untuk mengisi data tersebut." data-placement="bottom">{{$md5_nomer_telpon}}</a></td>
                                    <td class="text-center">-</td>
                                    <td class="text-center">-</td>
                                @endif
                            </tr>
                            ...
                            <tr class="text-center" class="text-center" data-toggle="modal" data-target="#modal-create">
                                @if ($cekkode_email == null)
                                    ...
                                    <td><a href="# " data-toggle="tooltip" title="Klik ini untuk mengisi data tersebut." data-placement="bottom">{{$md5_email}}</a></td>
                                    <td class="text-center">-</td>
                                    <td class="text-center">-</td>
                                @endif
                            </tr>
                            ...
                            <tr class="text-center" class="text-center" data-toggle="modal" data-target="#modal-create">
                                @if ($cekkode_social_facebook == null)
                                    ...
                                    <td><a href="# " data-toggle="tooltip" title="Klik ini untuk mengisi data tersebut." data-placement="bottom">{{$md5_social_facebook}}</a></td>
                                    <td class="text-center">-</td>
                                    <td class="text-center">-</td>
                                @endif
                            </tr>
                            ...
                            <tr class="text-center" class="text-center" data-toggle="modal" data-target="#modal-create">
                                @if ($cekkode_social_instagram == null)
                                    ...
                                    <td><a href="# " data-toggle="tooltip" title="Klik ini untuk mengisi data tersebut." data-placement="bottom">{{$md5_social_instagram}}</a></td>
                                    <td class="text-center">-</td>
                                    <td class="text-center">-</td>
                                @endif
                            </tr>
                            ...
                            <tr class="text-center" class="text-center" data-toggle="modal" data-target="#modal-create">
                                @if ($cekkode_social_youtube == null)
                                    ...
                                    <td><a href="# " data-toggle="tooltip" title="Klik ini untuk mengisi data tersebut." data-placement="bottom">{{$md5_social_youtube}}</a></td>
                                    <td class="text-center">-</td>
                                    <td class="text-center">-</td>
                                @endif
                            </tr>
