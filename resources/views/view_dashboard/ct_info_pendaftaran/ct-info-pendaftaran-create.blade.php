...
@section('content-wrapper')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">CT Informasi Pendaftaran Create</li>
        ...
        <div class="row">
            <div class="row justify-content-center" style="padding: 0px 15px 0px 15px;">                
                <div class="col-md-12">
                    ...
                    <form class="form-sample" action="{{route('ct-info-ppdb.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- /.box-body -->
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" name="name_section" class="form-control" id="exampleInputEmail1" autocomplete="off" placeholder="Example : Tata Cara Pendaftaran" required >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="note1" name="content_section"></textarea>
