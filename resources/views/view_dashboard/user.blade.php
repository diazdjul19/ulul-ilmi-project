                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group row" style="margin:0px;">
                                                <label class="col-md-2 col-form-label" for="foto_user"><h6 style="color: black; font-weight:bold;font-size:13px;">Security <span style="color: red;">*</span></h6></label>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @if ($d->level == 'A')
                                                @if ($d->status == 'not_active')
                                                    <a href="{{route('user.active', $d->id)}}" id="active-button" class="label label-warning" style="font-size: 12px;"  data-toggle="tooltip" title="Activate now" data-placement="top" ><i class="fa fa-clock-o"></i> Belum Aktif</a>
                                            ...
                                            @elseif($d->level == 'O')
                                                @if ($d->status == 'not_active')
                                                    <a href="{{route('user.active', $d->id)}}" id="active-button" class="label label-warning" style="font-size: 12px;" data-toggle="tooltip" title="Activate now" data-placement="top"><i class="fa fa-clock-o"></i> Belum Aktif</a>
                                                @elseif($d->status == 'active')
                                                    <a  href="{{route('user.not-active', $d->id)}}" id="non-active-button" class="label label-info" style="font-size: 12px;"  data-toggle="tooltip" title="Turn it off now" data-placement="top"><i class="fa fa-check-square-o"></i> User Aktif</a>
                                                @endif 
                                            @endif  
