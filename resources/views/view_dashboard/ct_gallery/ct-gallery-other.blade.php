...
@section('content-wrapper')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">CT Gallery OTHER</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">Table Gallery OTHER</h3>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group row" style="margin:0px;">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="name_image" class="form-control input-sm" id="name_image" placeholder="" required>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-9">
                                                    <select class="form-control" name="category_image" id="category_image" required>
                                                        <optgroup label="Pilih Category" >
                                                            ...
                                                            {{-- <option value="sdit_image">SDIT Image</option> --}}
                                            ...
                                            <div class="form-group row" style="margin:0px;">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="file" name="image" class="form-control input-sm" id="image" placeholder=""   >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group row" style="margin:0px;">
                                            ...
                                            <div class="col-md-5">
                                                <select class="form-control" name="category_image" id="" required>
                                                    ...
                                                    <option value="ma_image">MA Image</option>
                                                    <option value="mdt_image">MDT Image</option>
                                                    <option value="other_image" selected>OTHER Image</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row" style="margin:0px;">
                                ...
                                @foreach ($data as $d)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{route('ct-gallery-delete', $d->id)}}" id="btn-co-delete" class="btn btn-danger btn-xs"  style="margin: 3px;"><i class="fa fa-edit"></i> Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
