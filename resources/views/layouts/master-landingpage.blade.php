            ...
            <div class="main_menu">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="container">
                        ...
                        <a class="navbar-brand logo_h" href="#"><img src="/assets-ululilmi/logo.svg" style="width:300px; height:60px;" alt=""></a>
                        ...
                        <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            <ul class="nav navbar-nav menu_nav ml-auto">
                                ...
                                <li class="nav-item {{ request()->is('gallery-web') ? 'active' : '' }}"><a class="nav-link" href="{{route('gallery-web')}}">Gallery</a></li> 
                                <li class="nav-item {{ request()->is('content-web') ? 'active' : '' }}"><a class="nav-link" href="{{route('content-web')}}">Content Kami</a></li> 
                                <li class="nav-item {{ request()->is('contact-web') ? 'active' : '' }}"><a class="nav-link" href="{{route('contact-web')}}">Kontak</a></li>
                                <li class="nav-item"><a class="nav-link" href="#">Informasi Pendaftaran</a></li>
