...
@section('content-landingpage')
    <!--================About Area =================-->
        	...
        	<div class="container">
        		<div class="row about_inner">
					<div class="col-lg-4" style="margin:10px 0px 10px 0px;">
						...
						@if ($md5_logo_mdt != null)
							<span class="text-center">{!!$md5_logo_mdt->ct_pdd_text_content!!}</span>
						@elseif ($md5_logo_mdt == null)
							{{-- KOSONG --}}
						@endif
        			</div>
		...
		<div class="section-top-border">
			<div class="container">
				<h3 class="mb-30 title_color text-center">Gallery MDT</h3>
				<div class="row gallery-item">
					@foreach ($data_gallery_mdt as $d)
				...
				<div class="d-flex mt-2 mr-5 flex-wrap justify-content-center">
					...
					<ul class="pagination separated pagination-info">
						<li class="page-item">{{$data_gallery_mdt->links()}}</li>
					</ul>
					</nav>
				</div>
		...
		@foreach ($data_ct_custom_mdt as $d)
			<div class="section-top-border">
				<div class="container">
