...
@section('content-landingpage')
    <!--================About Area =================-->
        	...
        	<div class="container">
        		<div class="row about_inner">
					<div class="col-lg-4" style="margin:10px 0px 10px 0px;">
						{{-- <img class="img-fluid rounded mx-auto d-block" src="/assets-ululilmi/jenjang_pendidikan/mts.png" style="width:150px;height: 150px;" alt="Responsive image"> --}}
						@if ($md5_logo_mts != null)
							<span class="text-center">{!!$md5_logo_mts->ct_pdd_text_content!!}</span>
						@elseif ($md5_logo_mts == null)
							{{-- KOSONG --}}
						@endif
        			</div>
		...
		<div class="section-top-border">
			<div class="container">
				<h3 class="mb-30 title_color text-center">Gallery MTS</h3>
				<div class="row gallery-item">
					@foreach ($data_gallery_mts as $d)
				...
				<div class="d-flex mt-2 mr-5 flex-wrap justify-content-center">
					...
					<ul class="pagination separated pagination-info">
						<li class="page-item">{{$data_gallery_mts->links()}}</li>
					</ul>
					</nav>
				</div>
		...
		@foreach ($data_ct_custom_mts as $d)
			<div class="section-top-border">
				<div class="container">
