...
@section('content-landingpage')
    <!--================About Area =================-->
        	...
        	<div class="container">
        		<div class="row about_inner">
					<div class="col-lg-4" style="margin:10px 0px 10px 0px;">
						...
						@if ($md5_logo_ma != null)
							<span class="text-center">{!!$md5_logo_ma->ct_pdd_text_content!!}</span>
						@elseif ($md5_logo_ma == null)
							{{-- KOSONG --}}
						@endif
        			</div>
			...
			<div class="container">
				...
				<div class="d-flex mt-2 mr-5 flex-wrap justify-content-center">
					...
					<ul class="pagination separated pagination-info">
						<li class="page-item">{{$data_gallery_ma->links()}}</li>
					</ul>
					</nav>
				</div>
		...
		@foreach ($data_ct_custom_ma as $d)
			<div class="section-top-border">
				<div class="container">
