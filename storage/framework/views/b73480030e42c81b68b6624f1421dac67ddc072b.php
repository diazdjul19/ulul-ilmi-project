    ...
    <body class="hold-transition skin-blue sidebar-mini">
            ...
            <div class="navbar-custom-menu">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <li class="user-footer">
                        <div class="pull-left">
                        <a href="<?php echo e(route('user.edit', Auth::user()->id)); ?>" class="btn btn-default btn-flat">Profil & Password</a>
                        </div>
        ...
        <aside class="main-sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview <?php echo e(request()->is('home', 'user', 'user/*/edit', 'user/*') ? 'active' : ''); ?>">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li class="<?php echo e(request()->is('home') ? 'active' : ''); ?>"><a href="<?php echo e(route('home')); ?>"><i class="fa fa-circle-o"></i> Dashboard</a></li>

                        <?php if(Auth::user()->level == 'A'): ?>
                            <li class="<?php echo e(request()->is('user', 'user/*/edit', 'user/*') ? 'active' : ''); ?>"><a href="<?php echo e(route('user.index')); ?>"><i class="fa fa-circle-o"></i> User Management</a></li>
                        <?php elseif(Auth::user()->level == 'O'): ?>
                ...
                <li class="treeview <?php echo e(request()->is('ct-home', 'ct-home-create-md5tob/*', 'ct-home-create-md5ts/*', 'ct-home-create-md5tcb/*', 'ct-home-create-custom','ct-home-edit/*') ? 'active' : ''); ?>">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li class="<?php echo e(request()->is('ct-home', 'ct-home-create-md5tob/*', 'ct-home-create-md5ts/*', 'ct-home-create-md5tcb/*', 'ct-home-create-custom','ct-home-edit/*') ? 'active' : ''); ?>"><a href="<?php echo e(route('ct-home')); ?>"><i class="fa fa-circle-o"></i> CT Home</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview <?php echo e(request()->is(
                    ...
                    <ul class="treeview-menu">
                        <li class="<?php echo e(request()->is('ct-pdd-sdit', 'ct-pdd-sdit-create-default', 'ct-pdd-sdit-create-custom', 'ct-pdd-sdit-edit/*') ? 'active' : ''); ?>"><a href="<?php echo e(route('ct-pdd-sdit')); ?>"><i class="fa fa-circle-o"></i> CT SDIT</a></li>
                        <li class="<?php echo e(request()->is('ct-pdd-mts', 'ct-pdd-mts-create-default', 'ct-pdd-mts-create-custom', 'ct-pdd-mts-edit/*') ? 'active' : ''); ?>"><a href="<?php echo e(route('ct-pdd-mts')); ?>"><i class="fa fa-circle-o"></i> CT MTS</a></li>
                        <li class="<?php echo e(request()->is('ct-pdd-ma', 'ct-pdd-ma-create-default', 'ct-pdd-ma-create-custom', 'ct-pdd-ma-edit/*') ? 'active' : ''); ?>"><a href="<?php echo e(route('ct-pdd-ma')); ?>"><i class="fa fa-circle-o"></i> CT MA</a></li>
                        <li class="<?php echo e(request()->is('ct-pdd-mdt', 'ct-pdd-mdt-create-default', 'ct-pdd-mdt-create-custom', 'ct-pdd-mdt-edit/*') ? 'active' : ''); ?>"><a href="<?php echo e(route('ct-pdd-mdt')); ?>"><i class="fa fa-circle-o"></i> CT MDT</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview <?php echo e(request()->is(
                    ...
                    <ul class="treeview-menu">
                        <li class="<?php echo e(request()->is('ct-gallery-sdit') ? 'active' : ''); ?>"><a href="<?php echo e(route('ct-gallery-sdit')); ?>"><i class="fa fa-circle-o"></i> CT Gallery SDIT</a></li>
                        <li class="<?php echo e(request()->is('ct-gallery-mts') ? 'active' : ''); ?>"><a href="<?php echo e(route('ct-gallery-mts')); ?>"><i class="fa fa-circle-o"></i> CT Gallery MTS</a></li>
                        <li class="<?php echo e(request()->is('ct-gallery-ma') ? 'active' : ''); ?>"><a href="<?php echo e(route('ct-gallery-ma')); ?>"><i class="fa fa-circle-o"></i> CT Gallery MA</a></li>
                        <li class="<?php echo e(request()->is('ct-gallery-mdt') ? 'active' : ''); ?>"><a href="<?php echo e(route('ct-gallery-mdt')); ?>"><i class="fa fa-circle-o"></i> CT Gallery MDT</a></li>
                        <li class="<?php echo e(request()->is('ct-gallery-other') ? 'active' : ''); ?>"><a href="<?php echo e(route('ct-gallery-other')); ?>"><i class="fa fa-circle-o"></i> CT Gallery OTHER</a></li>

                    </ul>
                </li>

                <li class="treeview <?php echo e(request()->is('ct-creator', 'ct-content') ? 'active' : ''); ?>">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li class="<?php echo e(request()->is('ct-creator') ? 'active' : ''); ?>"><a href="<?php echo e(route('ct-creator')); ?>"><i class="fa fa-circle-o"></i> CT Creator</a></li>
                        <li class="<?php echo e(request()->is('ct-content') ? 'active' : ''); ?>"><a href="<?php echo e(route('ct-content')); ?>"><i class="fa fa-circle-o"></i> CT Content</a></li>
                    </ul>
                </li>

                <li class="treeview <?php echo e(request()->is('ct-contact') ? 'active' : ''); ?>">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li class="<?php echo e(request()->is('ct-contact') ? 'active' : ''); ?>"><a href="<?php echo e(route('ct-contact.index')); ?>"><i class="fa fa-circle-o"></i> CT Contact</a></li>
                    </ul>
                </li>

                <li class="treeview <?php echo e(request()->is('ct-info-ppdb', 'ct-info-ppdb/create' , 'ct-info-ppdb/*/edit') ? 'active' : ''); ?>">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li class="<?php echo e(request()->is('ct-info-ppdb', 'ct-info-ppdb/create' , 'ct-info-ppdb/*/edit') ? 'active' : ''); ?>"><a href="<?php echo e(route('ct-info-ppdb.index')); ?>"><i class="fa fa-circle-o"></i> CT Informasi Pendaftaran</a></li>
                    </ul>
                </li>
        ...
        <?php echo $__env->yieldPushContent('summernote'); ?>
        <?php echo $__env->yieldPushContent('select-custom'); ?>
        <?php echo $__env->yieldPushContent('custom-maps'); ?>
        <?php echo $__env->make('sweetalert::alert', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </body>
</html>
<?php /**PATH C:\laragon\www\ulul-ilmi-project\resources\views/layouts/master-dashboard.blade.php ENDPATH**/ ?>