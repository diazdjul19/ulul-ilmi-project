        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    ...
                    <a href="<?php echo e(route('user.show', Auth::user()->id)); ?>" class="btn btn-primary btn-block"><b>View Detail</b></a>
                    </div>
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->
...
<?php echo $__env->make('layouts.master-dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ulul-ilmi-project\resources\views/view_dashboard/home-custom.blade.php ENDPATH**/ ?>