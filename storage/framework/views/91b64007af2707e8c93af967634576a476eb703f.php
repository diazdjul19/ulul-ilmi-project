...
<?php $__env->startSection('content-landingpage'); ?>
    <!--================About Area =================-->
        	...
        	<div class="container">
        		<div class="row about_inner">
					<div class="col-lg-4" style="margin:10px 0px 10px 0px;">
						...
						<?php if($md5_logo_ma != null): ?>
							<span class="text-center"><?php echo $md5_logo_ma->ct_pdd_text_content; ?></span>
						<?php elseif($md5_logo_ma == null): ?>
		...
		<div class="section-top-border">
			<div class="container">
				<h3 class="mb-30 title_color text-center">Gallery MA</h3>
				<div class="row gallery-item">
					<?php $__currentLoopData = $data_gallery_ma; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				...
				<div class="d-flex mt-2 mr-5 flex-wrap justify-content-center">
					...
					<ul class="pagination separated pagination-info">
						<li class="page-item"><?php echo e($data_gallery_ma->links()); ?></li>
					</ul>
					</nav>
				</div>
		...
		<?php $__currentLoopData = $data_ct_custom_ma; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<div class="section-top-border">
				<div class="container">
...
<?php echo $__env->make('layouts.master-landingpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ulul-ilmi-project\resources\views/view_landingpage/pendidikan-ma-web.blade.php ENDPATH**/ ?>