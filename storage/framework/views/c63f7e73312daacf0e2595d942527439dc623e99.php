...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            <ul class="nav navbar-nav menu_nav ml-auto">
                                <li class="nav-item <?php echo e(request()->is('/','home-web') ? 'active' : ''); ?>"><a class="nav-link" href="<?php echo e(route('home-web')); ?>">Home</a></li> 
                                <li class="nav-item submenu dropdown <?php echo e(request()->is('pendidikan-sdit-web', 'pendidikan-mts-web', 'pendidikan-ma-web', 'pendidikan-mdt-web') ? 'active' : ''); ?>">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item "><a class="nav-link" href="<?php echo e(route('pendidikan-sdit-web')); ?>">SDIT</a></li>
                                        <li class="nav-item "><a class="nav-link" href="<?php echo e(route('pendidikan-mts-web')); ?>">MTs</a></li>
                                        <li class="nav-item "><a class="nav-link" href="<?php echo e(route('pendidikan-ma-web')); ?>">MA</a></li>
                                        <li class="nav-item "><a class="nav-link" href="<?php echo e(route('pendidikan-mdt-web')); ?>">MDT</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item submenu dropdown <?php echo e(request()->is('gallery-web', 'content-web') ? 'active' : ''); ?>">
                                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">About</a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item "><a class="nav-link" href="<?php echo e(route('gallery-web')); ?>">Abount Gallery</a></li>
                                        <li class="nav-item "><a class="nav-link" href="<?php echo e(route('content-web')); ?>">Abount Content</a></li>
                                    </ul>
                                </li> 
                                <li class="nav-item submenu dropdown <?php echo e(request()->is('logreg-creator') ? 'active' : ''); ?>">
                                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Login</a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item "><a class="nav-link" href="<?php echo e(route('logreg-creator')); ?>">Log-Reg Creator</a></li>
                                        <li class="nav-item "><a class="nav-link" href="">Log Siswa</a></li>
                                    </ul>
                                </li> 
                                
                                <li class="nav-item submenu dropdown <?php echo e(request()->is('info-ppdb-web') ? 'active' : ''); ?>">
                                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">PPDB</a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item "><a class="nav-link" href="<?php echo e(route('info-ppdb-web')); ?>">Info Pendaftaran</a></li>
                                        <li class="nav-item "><a class="nav-link" href="">Form Pendaftaran</a></li>
                                        <li class="nav-item "><a class="nav-link" href="">Hasil Seleksi</a></li>
                                    </ul>
                                </li> 
                                
                                <li class="nav-item <?php echo e(request()->is('contact-web') ? 'active' : ''); ?>"><a class="nav-link" href="<?php echo e(route('contact-web')); ?>">Kontak</a></li>
                            </ul>
        ...
        <!--================Header Menu Area =================-->
			...
			<?php echo $__env->yieldContent('content-landingpage'); ?>
...
</html><?php /**PATH C:\laragon\www\ulul-ilmi-project\resources\views/layouts/master-landingpage.blade.php ENDPATH**/ ?>